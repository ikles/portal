...
?>
<article class="<?php echo $this->pageclass_sfx; ?> catid-<?php echo $catid; ?> item item-page<?php echo $this->pageclass_sfx . ($this->item->featured) ? ' item-featured' : ''; ?>" itemscope itemtype="http://schema.org/Article">
    ...
    <div class="wrapper-article"> 
        ...
        <div class="articleContent"> 
        	...
        	<?php else : ?>
        		...
        		<?php endif; ?>
        	<?php endif; ?><?php if (!$params->get('show_intro')) : echo $this->item->event->afterDisplayTitle; endif; ?>
