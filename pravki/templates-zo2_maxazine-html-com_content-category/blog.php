...
<div class="items-intro">
	<?php if (!empty($this->intro_items)) : ?>
		<?php foreach ($this->intro_items as $key => &$item) : ?>
			...
			<div class="col-xs-12 col-sm-<?php echo round((12 / $this->columns)); ?>">
				<article class="grid-style item column-<?php echo $rowcount; ?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?><?php echo $item->featured ? ' item-featured' : ''; ?>"
					itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting">
					<?php
					$this->item = & $item;
					echo $this->loadTemplate('intros_item');
					?>
				</article>
				<!-- end item -->
				<?php $counter++; ?>
	...
	<?php if (!empty($this->link_items)) : ?>
		<?php foreach ($this->link_items as $key => &$item) : ?>
			...
			<?php endif; ?>
			<div class="col-xs-12 col-sm-<?php echo round((12 / $this->columns)); ?>">
				<article class="list-style item column-<?php echo $rowcount; ?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?><?php echo $item->featured ? ' item-featured' : ''; ?>"
					itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting">
					<?php
					$this->item = & $item;
